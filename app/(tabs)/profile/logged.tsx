  ...
  return (
    <SafeAreaView className="flex-col bg-secondary" edges={['top', 'bottom']}>
      <ScrollView>
        ...
        <View className="flex-row relative items-center justify-center bg-white h-52">
          {/* <svg
            xmlns="http://www.w3.org/2000/svg"
            height="200px"
            viewBox="0 -960 960 960"
          ...
          <View className="mx-5 mt-6 h-32 w-32 rounded-full bg-accountOrange items-center justify-center">
            <Text className="mx-5 mt-6 text-white font-bold">{fullInitials}</Text>
          </View>
          <View className="flex-col">
            <Text>{firstName} {lastName}</Text>
            <Text className="text-sm text-gray-500">Member since {createdAt?.slice(0, 10)}</Text>
          </View>
        </View>
      </ScrollView>
    </SafeAreaView>
