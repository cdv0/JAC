...
export const ServiceRecord = () => {
  ...
  const isFileInvalid =
    ...
    files.some(
      (file) =>
        file.size > MAX_RECORD_SIZE ||
        !ALLOWED_MIME_TYPES_RECORD.includes(file.mimeType ?? "")
    );
      ...
      if (files.length > 0) {
        try {
          for (const file of files) {
            ...
            console.log(
              "Add service record: Service records upload successful:",
              recordFileKey
            );
      ...
      <ScrollView className="flex-1 bg-white">
        <View className="mx-5 mt-3 gap-3 mb-5">
          <View className="gap-2">
            ...
            <TextInput
              ...
              className={`border rounded-full px-4 py-2 smallTextGray ${
                isTitleInvalid ? "border-dangerBrightRed" : "border-stroke"
              }`}
            />
            {isTitleInvalid ? (
          ...
          <View className="gap-2">
            ...
            >
              <Text className="smallTextGray">{formatDate(date)}</Text>
            </Pressable>
              ...
              >
                ...
                >
                  <View className="bg-white p-8">
                    ...
                    >
                      <Text className="text-primaryBlue font-semibold">
                        Done
                      </Text>
                    </Pressable>
                    <DateTimePicker
          ...
          <View className="gap-2">
            ...
            <TextInput
              ...
              className={
                "border rounded-full px-4 py-2 smallTextGray border-stroke"
              }
            />
          </View>
          ...
          <View className="gap-2">
            ...
            <TextInput
              ...
              className={
                "border rounded-xl px-4 py-2 smallTextGray border-stroke"
              }
            />
          </View>
          ...
          <View className="gap-2">
            ...
            <Text className="xsTextGray">
              Up to 1MB per file in JPG or PNG
            </Text>
            <Pressable
            ...
            <View className="w-full mb-3 gap-2 mx-3 self-center">
                <View className="bg-white px-4 py-3 rounded-lg">
                  ...
                  <Pressable className="py-3 border-stroke">
                    <Text className="smallText" onPress={handleChooseFile}>
                      Choose a file
                    </Text>
                  </Pressable>
                </View>
