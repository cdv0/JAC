...
export default function MechanicView(
    {
        ...
        return(
            ...
            <Link href={`../mechanic/${mechanicID}`} asChild>
                <TouchableOpacity style={{ width:195, height:270}}>
                    <View className = "w-full h-full rounded-xl border border-stroke py-[2%]">
                        ...
                        <View className ="my-[5%] ml-[15%]">
                            <View className="flex-row items-center">
                                <View className=' w-[80%]'>
                                    <Text className = {`smallTitle mr-[5%]`}>
                             ...
                             <View className="flex-row ">
                                <Text className='smallTextBold'>Rating: </Text>
                            ...
                            <Text className='smallTextBold'>Reviews: {Review}</Text>
                            {(Distance && Distance !== Number.POSITIVE_INFINITY) && <Text className='smallTextGray'>{Distance.toFixed(1)} mi</Text>}
                        </View>
                    </View> 
                </TouchableOpacity>    
            </Link>
